...
var components = {
  uniGrid: function() {
    return __webpack_require__.e(/*! import() | components/uni-grid/uni-grid */ "components/uni-grid/uni-grid").then(__webpack_require__.bind(null, /*! @/components/uni-grid/uni-grid.vue */ 43))
  },
  uniGridItem: function() {
    return __webpack_require__.e(/*! import() | components/uni-grid-item/uni-grid-item */ "components/uni-grid-item/uni-grid-item").then(__webpack_require__.bind(null, /*! @/components/uni-grid-item/uni-grid-item.vue */ 50))
  }
}
var render = function() {
  var _vm = this
...
var _spaceModel = _interopRequireDefault(__webpack_require__(/*! ./space-model.js */ 41));
var _roomZone = _interopRequireDefault(__webpack_require__(/*! ./room-zone.js */ 42));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =
{
  data: function data() {
    return {
      spaces: [],
  ...
  methods: {
    ...
    requestAppInfo: function requestAppInfo() {var _this = this;
      // 请求AppInfo信息
      uni.request({
        ...
        success: function success(res) {
          if (res.statusCode == 200) {
            _this.handleAppInfo(res.data.data);
          } else {
    ...
    handleAppInfo: function handleAppInfo(data) {
      this.spaces = data.accessibleSpaces.map(function (obj) {return new _spaceModel.default(obj);});
    ...
    requestIoTTemplate: function requestIoTTemplate() {var _this2 = this;
      if (this.currentSpace) {
        uni.request({
          url: "https://uat-gateway.stey.com/iot-service/app/iot/template/".concat(this.currentSpace.spaceId),
          method: 'GET',
          data: {},
          header: {
            'Content-Type': 'application/json; charset=utf-8',
          ...
          success: function success(res) {
            if (res.statusCode == 200) {
              _this2.handleTemplate(res.data.data.zones);
            } else {
              var error = res.data.error;
              if (error) {
                uni.showToast({
  ...
  (0, _vuex.mapState)(['isLogin'])) };exports.default = _default;
